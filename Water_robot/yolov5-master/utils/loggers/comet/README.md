...
export COMET_PROJECT_NAME=<Your Comet Project Name> # This will default to 'tensorrt'
```
...
export COMET_MODEL_NAME=<your model name> #Set the name for the saved model. Defaults to tensorrt
