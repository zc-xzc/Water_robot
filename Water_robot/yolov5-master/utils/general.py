...
def check_git_status(repo='ultralytics/tensorrt', branch='master'):
...
def strip_optimizer(f='1.pt', s=''):  # from utils.general import *; strip_optimizer()
